...
class _FeedWidgetState extends State<FeedWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResult7i4 = await AuthenticatedGroup.getMeCall.call();
    });
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Align(
              ...
              child: Image.asset(
                'assets/images/RO_-_Social_Media_-_PP2_(1).png',
                width: 50.0,
                height: 50.0,
                fit: BoxFit.cover,
              ),
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return Row(
                                          ...
                                          children: List.generate(
                                              userStoriesStoriesRecordList
                                                  .length, (userStoriesIndex) {
                                            final userStoriesStoriesRecord =
                                                userStoriesStoriesRecordList[
                                                    userStoriesIndex];
                                            return Visibility(
                                              visible: userStoriesStoriesRecord
                                                      .user !=
                                                  currentUserReference,
                                              child: Padding(
